# KCA Domain Coverage Plan

## Context

- Certification: KCA (Kyverno Certified Associate)
- Phase: Phase 3
- 90-day Window: Days 74-78 (Exam Day 79)

## High-Value Focus Areas

1. Kyverno policy lifecycle and governance
2. Validate, mutate, generate, and verifyImage patterns
3. Policy reporting and exception management
